export const BASIC_DESCRIPTION = {
    html: [
        ...
        },
        {
            ...
            body: {
                paragraphs: [
                    "Although the most common use case for Gantt Charts is project management, it can be used for other types of data sets, which consist of <strong>data over a period of time</strong>. In this case <strong>asset tracking</strong> data was visualised by using a Gantt chart.",
